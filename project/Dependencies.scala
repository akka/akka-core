...
object Dependencies {
  ...
  val jacksonCoreVersion = "2.21.7" // https://github.com/FasterXML/jackson/wiki/Jackson-Releases
  ...
  object Compile {
    // Compile
    val config = "com.typesafe" % "config" % "1.4.8" // ApacheV2
    ...
    val lz4Java = "at.yawk.lz4" % "lz4-java" % "1.11.1" // ApacheV2
  ...
  object TestDependencies {
    ...
    val metrics = "io.dropwizard.metrics" % "metrics-core" % "4.2.40" % Test // ApacheV2
    val metricsJvm = "io.dropwizard.metrics" % "metrics-jvm" % "4.2.40" % Test // ApacheV2
